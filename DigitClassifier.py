...
#Computing Value Loss and Value Accuracy

Val_loss, Val_acc = model.evaluate(x_test,y_test)
print("The value loss is ",Val_loss)
print("The value Accuracy is ", Val_acc)


model.save_weights("NumberRecognitionModelWeights.h5")

#Predicting certain values

Predictions = model.predict([x_test])

#Storing a prediction. It is of First Test Image
TestNumber = np.argmax(Predictions[0])
print("The First test image classifies to ", TestNumber)
plt.imshow(x_test[0])
plt.show()
